        ...
        <form action="<?= URL_RAIZ . 'clientes'?>" method="post">
            <div class="row">
                <div class="input-field col s12 m12 l6">
                    ...
                    <input type="text" name="primeiroNome" placeholder="Darth">
                    <label for="icon_prefix">Primeiro Nome</label>
                </div>
                <div class="input-field col s12 m12 l6">
                    <i class="material-icons prefix">person</i>
                    <input type="text" name="sobrenome" placeholder="Vaider">
            ...
            <div class="row">
                <div class="input-field col s12 m6">
                    <i class="material-icons prefix">person</i>
                    <input id="input-cpf" name="cpf" class="cpf" type="text" class="cep" placeholder="000.000.000-00">
