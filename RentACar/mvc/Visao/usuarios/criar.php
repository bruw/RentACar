        ...
        <form action="<?= URL_RAIZ . 'usuarios'?>" method="post">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l6">
                    ...
                    <input type="text" name="primeiroNome" placeholder="Larissa">
                    <label for="icon_prefix">Primeiro Nome</label>
                </div>
                <div class="input-field col s12 m12 l6">
                    <i class="material-icons prefix">person</i>
                    <input type="text" name="sobrenome" placeholder="Ferreira">
            ...
            <div class="row">
                <div class="input-field col s12 m6">
                    ...
                    <input type="email" name="email" placeholder="larissai@gmail.com">
                    <label for="icon_prefix">Email</label>
                </div>

                <div id="div-celular" class="input-field col s12 m6">
                    <i class="material-icons prefix">phone_iphone</i>
                    <input class="celular" name="celular" type="text" placeholder="(00)00000-0000">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l6">
                    <i class="material-icons prefix">person</i>
                    <input class="cpf" name="cpf" type="text" placeholder="000.000.000-00">
            ...
            <div class="row">
                <div class="input-field col s12 m12 l6">
                    ...
                    <input id="input-cep" name="cep" class="cep" type="text" placeholder="85070700">
                    <label for="icon_prefix">CEP</label>
                </div>
                <div class="input-field col s12 m12 l6">
                    <i class="material-icons prefix">markunread_mailbox</i>
                    <input id="input-numero" name="numero" type="number" placeholder="1024">
